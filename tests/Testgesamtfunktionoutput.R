...
# prof <- profvis({
#   y <- ELLsae(model = mod, surveydata = surv, censusdata = cens, location_survey = loc, n_boot = 250, parallel = F)
# })
...
# prof3 <- profvis({
#   y <- ELLsae2(model = mod, surveydata = surv, censusdata = cens, location_survey = loc, n_boot = 250, parallel = F)
# })
# 
# debugonce(ELLsae2)
# 
