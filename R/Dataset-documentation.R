...
#' Number of variables and observations are reduced to a size for a reasonable example 
#' of the ELLsae package. The full documentation can be found here: 
...
#'  \item{geo2_br}{inconsistent level two boundaries of Brazil, Municipality 1980 - 2010}
...
#'@name brazil
#'@usage data(brazil)
#'@references Brazilian Institute of Geography and Statistics (IBGE). Brazil Demographic Census 2010. Rio de Janeiro, Brazil: 
#'Brazilian Institute of Geography and Statistics (IBGE), 2012.
#'@seealso Random data can also be generated using the \code{randomSAEdata} function contained in this package.
#'
NULL